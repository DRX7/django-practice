...
class CreateComment(CanCreateMixin, CommentCreateMixin):
	...
	def form_valid(self, form):
		...
		# -------Send email for notification {System Email}--------
		...
		if parent_email:
			mail_subject = "دریافت دیدگاه"
			message = "شخصی به نظر شما پاسخ داد اگر مایلید میتوانید آن را ببینید"
			email = EmailMessage(
